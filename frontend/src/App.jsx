...
// Follow Button Component (reuse from ShoesPage)
function FollowButtonDress({ userId }) {
...
// Designer Card for Dress Page (with like/share/comment/follow)
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {primaryImage && <img src={primaryImage.url} alt="Dress" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />}
        <div style={{
          position: 'absolute',
          top: 12,
          left: '50%',
      ...
      <div style={{ flex: 1, position: 'relative' }}>
        <div style={{
          ...
          {design.user?._id && design.user._id !== user?._id && (
            <FollowButtonDress userId={design.user._id} />
          )}
        </div>
